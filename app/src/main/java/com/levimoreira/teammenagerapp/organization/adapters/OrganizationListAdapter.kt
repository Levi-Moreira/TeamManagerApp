...
class OrganizationListAdapter(private val list: List<Organization>) : androidx.recyclerview.widget.RecyclerView.Adapter<OrganizationListAdapter.OrganizationViewHolder>() {
    ...
    inner class OrganizationViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
